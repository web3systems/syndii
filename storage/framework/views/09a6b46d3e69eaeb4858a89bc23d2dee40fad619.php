								...
								<?php if(App\Services\HelperService::extensionWalletFeature()): ?>
									<div class="col-sm-12">
										<div class="text-center pt-4">
											<a href="<?php echo e(route('user.wallet')); ?>" class="fs-13"><i class="fa-solid fa-wallet mr-1"></i> <?php echo e(__('My Wallet')); ?></a>
										</div>
									</div>
								<?php endif; ?>
							<?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/syndii.net/public_html/resources/views/default/user/profile/index.blade.php ENDPATH**/ ?>