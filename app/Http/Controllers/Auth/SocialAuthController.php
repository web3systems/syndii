        ...
        try {
            ...
            if ($existing_user) {
                ...
                if ($check_user) {
                    ...
                    $new_user->images = $settings->image_credits;
                    $new_user->tokens = $settings->token_credits;
                    $new_user->characters = config('settings.voiceover_welcome_chars');
                    $new_user->minutes = config('settings.whisper_welcome_minutes');
